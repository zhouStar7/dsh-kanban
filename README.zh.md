...
```bash
dsh plugin --profile web add "https://github.com/zhouStar7/dsh-k/releases/latest/download/dsh-k.tgz"
```
...
> 强制刷新安装：`dsh plugin --profile web remove @deepseek-kanban/plugin && dsh plugin --profile web add "https://github.com/zhouStar7/dsh-k/releases/latest/download/dsh-k.tgz"`
...
![看板面板](https://raw.githubusercontent.com/zhouStar7/dsh-k/main/docs/assets/kanban-board.png)
...
![新建任务](https://raw.githubusercontent.com/zhouStar7/dsh-k/main/docs/assets/new-task-dialog.png)
